...
namespace Phyah.Concurrent
{
    ...
    public class MultiExecutor : IExecutorGroup
    {
        ...
        static readonly Func<IExecutorGroup, IExecutor> DefaultEventLoopFactory = group => new IndependentThreadExecutor("IndependentThreadExecutor Multi",TimeSpan.Zero);
